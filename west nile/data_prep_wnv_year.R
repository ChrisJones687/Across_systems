...
count <- inat_mosquitoes$num_identification_agreements
lon <- inat_mosquitoes$longitude
lat <- inat_mosquitoes$latitude
...
CA_total_mosquitoes <- SpatialPointsDataFrame(CA18_mosquitoes_lon_lat,inat_mosquitoes)
mosquitoes_crs <- crs(mosquitoes_crs)
total_mosquitoes <- rasterize(CA_total_mosquitoes, california_nlcd_3000m, field = "count", fun = 'sum', mask= TRUE, background = 0) 
total_mosquitoes <- mask(total_mosquitoes, california)
...
lat <- CA17_birds$LATITUDE
count <- CA17_birds$count
CA17_data_frame <- cbind.data.frame(count)
CA17_birds_lon_lat <- cbind.data.frame(lon, lat)
california_crs <- st_crs(california_nlcd_3000m)
...
lat <- CA16_birds$LATITUDE
count <- CA16_birds$count
CA16_data_frame <- cbind.data.frame(count)
CA16_birds_lon_lat <- cbind.data.frame(lon, lat)
california_crs <- st_crs(california_nlcd_3000m)
...
lat <- CA15_birds$LATITUDE
count <- CA15_birds$count
CA15_data_frame <- cbind.data.frame(count)
CA15_birds_lon_lat <- cbind.data.frame(lon, lat)
california_crs <- st_crs(california_nlcd_3000m)
...
lat <- CA14_birds$LATITUDE
count <- CA14_birds$count
CA14_data_frame <- cbind.data.frame(count)
CA14_birds_lon_lat <- cbind.data.frame(lon, lat)
california_crs <- st_crs(california_nlcd_3000m)
...
lat <- CA13_birds$LATITUDE
count <- CA13_birds$count
CA13_data_frame <- cbind.data.frame(count)
CA13_birds_lon_lat <- cbind.data.frame(lon, lat)
california_crs <- st_crs(california_nlcd_3000m)
