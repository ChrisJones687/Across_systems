...
infected_file <- "G:/My Drive/EEID/Foot and Mouth Disease/states/virginia/infected.tif"
host_file <- "G:/My Drive/EEID/Foot and Mouth Disease/states/virginia/host.tif"
total_plants_file <- "G:/My Drive/EEID/Foot and Mouth Disease/states/virginia/total_hosts.tif"
temperature_file <- ""
...
# #infected_years_file <- "H:/Shared drives/SHIC Projects/test_data/cum_inf_2002_2004.tif"
# num_iterations <- 10
...
# host_file <- "H:/Shared drives/SHIC Projects/test_data/inf_2001.tif"
# total_plants_file <- "H:/Shared drives/SHIC Projects/test_data/lemma_max300m.tif"
# temperature_file <- ""
# temperature_coefficient_file <- "H:/Shared drives/SHIC Projects/test_data/weather_coef_2002_2005.tif"
# 
# 
# 
# mask = NULL
...
#                         mask, success_metric)
# 
# infected_years_file <- "H:/Shared drives/SHIC Projects/test_data/cum_inf_2005.tif"
# num_iterations <- 10
# 
# infected_file <- "H:/Shared drives/SHIC Projects/test_data/cum_inf_2004.tif"
# host_file <- "H:/Shared drives/SHIC Projects/test_data/lide_300m_median_2001.tif"
# total_plants_file <- "H:/Shared drives/SHIC Projects/test_data/lemma_max300m.tif"
# temperature_file <- ""
# temperature_coefficient_file <- "H:/Shared drives/SHIC Projects/test_data/weather_2005.tif"
# precipitation_coefficient_file <-""
