...
us_counties_cattle <- read.csv("G:/My Drive/EEID/Foot and Mouth Disease/colorado.csv")
...
VA_nlcd_3000m_pasture <- raster("G:/My Drive/EEID/Foot and Mouth Disease/VA_nlcd_3000m.img")
...
writeRaster(zip_cattle, "G:/My Drive/EEID/Foot and Mouth Disease/VA_zip_cattle.tif")
zip_cattle
...
#us_counties$area_of_pasture <- extract(nlcd_3000m_pasture, us_counties, fun = sum)
#writeOGR(COcounties, "/Users/rachellantz/Google Drive File Stream/My Drive/EEID/Foot and Mouth Disease/colorado_counties_pasturecattle.shp")
#counties_cattle <- read.csv("G:/My Drive/EEID/Foot and Mouth Disease/us_county_cattle.csv")
